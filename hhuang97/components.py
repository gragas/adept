...
class Projectile(particle.Particle):
    def __init__(self, sprite, proj_anim_list, proj_anim_time_list, width, height,
                life, position, velocity, acceleration):
        particle.Particle.__init__(self, sprite, life, position, velocity, acceleration)
        self.entity_ID = None
...
class Attack(particle.Emitter):
    ...
    def __init__(self, world, damage, stun, cooldown, position, amount,
        ...
        """
        particle.Emitter.__init__(self, cooldown, position, amount,
    ...
    def spawn_particles(self, direction=None, velocity=None, position=None):
        ...
        spawned = particle.Emitter.spawn_particles(self, velocity, position)
        if spawned:
            ...
            for particle in spawned:
                ...
                angle = particle.get_angle_between_vectors(particle.velocity, [1,0])
